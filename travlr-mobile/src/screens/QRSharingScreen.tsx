...
const QRSharingScreen: React.FC = () => {
  const navigation = useNavigation();
  const route = useRoute();
  const { credentialId, credentialData } = route.params as RouteParams || {};
  ...
  const handleShareData = async () => {
    ...
    try {
      console.log('🔄 Creating encrypted context card with KERI');
      
      // Get employee AID from SignifyTS
      const client = signifyService;
      if (!client) {
        throw new Error('SignifyTS service not available');
      }
      ...
      const contextCard = await contextCardService.createContextCard({
        ...
        selectedFields,
        purpose,
        credentialSaid: credentialId || 'travel-credential-said'
      });

      console.log('✅ Context card created:', contextCard.id);

      Alert.alert(
        'Data Shared Successfully! 🎉',
        `Your selected travel data has been securely encrypted and shared with ${companyName}.\n\nContext Card ID: ${contextCard.id}\n\nThey can access your approved data through OOBI discovery. You maintain full control and can revoke access anytime.`,
        [
          {
            text: 'Done',
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Share via Context Card</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.explanationCard}>
          ...
          <View style={styles.explanationText}>
            <Text style={styles.explanationTitle}>KERI Context Card Sharing</Text>
            <Text style={styles.explanationDescription}>
              Your data will be encrypted and shared as a context card. The recipient can discover and verify your data through OOBI (Out-Of-Band Introduction) without QR codes.
            </Text>
          </View>
        </View>
          ...
          <View style={styles.dataItem}>
            <View style={styles.dataInfo}>
              ...
              <View style={styles.dataDetails}>
                ...
                <Text style={styles.dataDescription}>Seating, meals, airlines</Text>
              </View>
            </View>
            <Switch
          ...
          <View style={styles.dataItem}>
            <View style={styles.dataInfo}>
              ...
              <View style={styles.dataDetails}>
                ...
                <Text style={styles.dataDescription}>Room type, amenities, chains</Text>
              </View>
            </View>
            <Switch
          ...
          <View style={styles.dataItem}>
            <View style={styles.dataInfo}>
              ...
              <View style={styles.dataDetails}>
                ...
                <Text style={styles.dataDescription}>Mobility, assistance requirements</Text>
              </View>
            </View>
            <Switch
...
export default QRSharingScreen;